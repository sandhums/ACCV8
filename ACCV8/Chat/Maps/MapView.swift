...
struct MapView: View {
    ...
    let annotationItemsChat: [MyAnnotationItem]
    ...
    var body: some View {
        Map(coordinateRegion: $region,
            ...
            annotationItems: annotationItemsChat) { item in
...
struct MapView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        AppearancePreviews(
            Group {
                NavigationView {
                    MapView(location: position, annotationItemsChat: [])
                }
                NavigationView {
                    MapView(location: position, annotationItemsChat: [MyAnnotationItem(coordinate: position)])
                }
            }
        )
    }
