...
struct ConsumptionRepView: View {
    ...
    @State private var consCat5 = ""
    @State private var consCat6 = ""
    @State private var consCat7 = ""
    @State private var consCat8 = ""
    @State private var consCat9 = ""
...
//                .opacity(0.8)
        ...
        .overlay (
            ...
            Group {
                ...
                HStack {
                Picker(selection: $consName5, label: Text("Select Stent")) {
                    Text("Nothing Selected")
                ...
                HStack {
                Picker(selection: $consName6, label: Text("Select Stent")) {
                    Text("Nothing Selected")
                    ForEach(wires, id: \.self) { wire in
                        Text(wire.name).tag(wire.name)
                    }
                ...
                HStack {
                Picker(selection: $consName7, label: Text("Select Stent")) {
                    Text("Nothing Selected")
                    ForEach(wires, id: \.self) { wire in
                        Text(wire.name).tag(wire.name)
                    }
            ...
            Group {
                ...
                HStack {
                Picker(selection: $consName8, label: Text("Select Stent")) {
                    Text("Nothing Selected")
                ...
                Group {
                    ...
                    HStack {
                    Picker(selection: $consName9, label: Text("Select Stent")) {
                        Text("Nothing Selected")
                    ...
                    HStack {
                    Picker(selection: $consName10, label: Text("Select Stent")) {
                        Text("Nothing Selected")
                        ForEach(others, id: \.self) { other in
                            Text( other.name).tag(other.name)
                        }
...
//                        .opacity(appear[0] ? 1 : 0)
    ...
    func saveProcRep() {
        ...
        let p9 = ConsumptionItems(value: ["category": consCat4, "name": consName9, "quantity": consQty9])
        let p10 = ConsumptionItems(value: ["category": consCat4, "name": consName10, "quantity": consQty10])
