    ...
    var body: some View {
            VStack {
                VStack(alignment: .leading, spacing: 14) {
                    Text("App Walkthrough - 2/5 - After Sign In")
                        .font(.footnote)
                        .fontWeight(.semibold)
                    ...
                    LinearGradient(
                        ...
                        .frame(height: 60)
                        .mask(Text("Centres List ")
                                .font(.title2)
                                .bold()
                                .frame(maxWidth: .infinity, alignment: .leading))
                    HStack {
                    Text("Main Screen. **Set your profile first** by clicking on top right corner. Centres are arranged horizontally on top (swipe sideways), and scrolling vertically below. Navigation menu tabs are below.")
                        .font(.subheadline)
                        .foregroundColor(Color.white.opacity(0.7))
                   ...
                   Image("logged")
                    ...
                    Text("Tap on a centre to show detailed view. Set your personal details and notification settings in the profile page")
                        .font(.subheadline)
                        .foregroundColor(Color.white.opacity(0.7))
                }
