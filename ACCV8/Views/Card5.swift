    ...
    var body: some View {
            VStack {
                VStack(alignment: .leading, spacing: 14) {
                    ...
                    HStack {
                    Text("List of New Projects. Tap on a  Project to show ongoing Tasks with progress details. Only users with necessary permissions can add/modify projects and tasks.")
                        .font(.subheadline)
                        .foregroundColor(Color.white.opacity(0.7))
...
struct Card5_Previews: PreviewProvider {
